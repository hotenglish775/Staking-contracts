Key improvements made to the contract:
   ...
   Added an emergencyWithdraw function to allow the contract owner to recover tokens sent to the contract accidentally
Added events for reward rate updates and emergency withdrawals
Enhanced the setRewardRate function with the proper updateReward modifier

The contract now properly reflects that it's working with ACC-20 tokens on your custom chain while maintaining the core functionality and security features of the original contract.
